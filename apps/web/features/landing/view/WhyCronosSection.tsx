          ...
          <ScrollAnimation animation="stagger" className="grid gap-8 md:grid-cols-2">
            ...
            <Card className="group hover:border-primary/50 hover:shadow-lg transition-all duration-300 bg-card/50">
              <CardHeader className="space-y-4">
                ...
                <CardTitle className="text-xl">Built for Mantle Sepolia</CardTitle>
                <CardDescription className="text-base leading-relaxed">
                  mani is deployed on Mantle Sepolia and integrates directly with Mantle protocols, enabling agent-driven swaps, data access and on-chain automation.
                </CardDescription>
              </CardHeader>
            </Card>
