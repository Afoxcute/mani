      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              <span>Built on Mantle Sepolia</span>
            ...
            >
              mani is an agent-native x402 execution fabric that lets AI agents safely
              interact with paid APIs and on-chain workflows on Mantle Sepolia — without ever accessing
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="relative p-8 rounded-2xl border-2 border-primary/30 bg-primary/5">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-lg font-semibold text-foreground block">mani</span>
                ...
                <div className="flex items-center gap-12">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-muted-foreground">Mantle</span>
                  </div>
                </div>
              </div>
            </div>
