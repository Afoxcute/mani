...
export interface UseAuthorizationFlowReturn {
  ...
  /** Effective chain ID (from connection or default to Mantle Sepolia Testnet) */
...
export function useAuthorizationFlow(
  ...
  // Use connected chain or default to Mantle Sepolia Testnet
  const effectiveChainId = chainId ?? mantleSepoliaTestnet.id
